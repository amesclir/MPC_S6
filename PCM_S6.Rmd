...
El segundo modelo que ajustamos es el modelo dependiente en el que el estado de caracter de un rasgos binario depende Del otro y viceversa.
...
MODELOS DE EVOLUCÓN DE CARACTERES DISCRETOS CON MÚLTIPLES REGÍMENES
...
Lo que vemos es que en el panel c, algunas veces el caracter cambia rápidamente entre estados y otras veces el estado de caracter 1 se mantiene estabale en a lo largo de mucho tiempo evolutivo (en el panel a los cambios son simpre frecuentes). En el panel b podemos observar que en realidad estamos en el estado 1* cuando en el panel c pensamos que estamos en el estado 1.


Pasemos ahora a ajutar nuestro modelo hidden-rates con datos reales. Usemos el set de datos del número de dedos en el linaje squamatae.
...
Para ello usaremos lo datos de Williams et al., (2014) en la que los autores investigan la evolución del polen bicelular y tricelular. Usaremos un subconjunto de datos  para agelizar el proceso computacional.
